...
/**
 * Script to build Fokkus IDE with a local Theia framework development version.
 *
 * This allows testing Fokkus IDE changes against local Theia framework modifications
 ...
 *   --skip-ide-build      Skip building Fokkus IDE (use for linking only) [default: false]
...
This script builds the Fokkus IDE against a local Theia framework checkout,
...
function linkTheiaPackages() {
    ...
    console.log(`Fokkus IDE requires ${requiredDeps.size} @theia/* packages\n`);
 ...
 */
async function main() {
    console.log('\nBuild Fokkus IDE with local Theia framework\n');
